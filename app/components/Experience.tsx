      ...
      <div className="container mx-auto">
        ...
        <div className="text-base md:text-lg">
          <p className="mb-4">
            ...
            was the chairperson of NITO Studentene, along with my other
            upperclassman, both of whom were dedicated students actively involved
            in organizations like NITO and Systematicus (the student organization
            for IT).
          </p>
          <p className="mb-4">
            During an introductory event, my upperclassman introduced me to NITO
            at their booth, and I was immediately captivated. After hearing about
            the fantastic benefits NITO provides its members—such as insurance,
            career services, networking opportunities, and free academic courses
            and social events throughout our studies—I knew I wanted to join. I
