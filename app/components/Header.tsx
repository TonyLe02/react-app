...
const Header = () => {
  ...
  return (
    <>
      <nav className="bg-white shadow border-gray-200 overflow absolute top-0 w-full z-50">
              ...
              {["About", "Contact", "Internship", "Projects"].map((item) => (
                <li key={item}>
                  <a
                    ...
                    className="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-orange-500 md:p-0 text-gray-900"
                  >
                    {item}
                  </a>
                </li>
